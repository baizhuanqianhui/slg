 ...
 * @version 1.0
 */
public class MarkException extends Exception implements Message{
    ...
    public MarkException(String arg0, Object args[])
    {
        super(arg0);
        msg = new MessageImpl();
        this.args = args;
    ...
    public MarkException(String arg0, Throwable arg1)
    {
        super(arg0, arg1);
        msg = new MessageImpl();
        if(arg0 == null || arg0.trim().length() == 0)
    ...
    public MarkException(String arg0, Throwable arg1, Object args[])
    {
        super(arg0, arg1);
        msg = new MessageImpl();
        this.args = args;
    ...
    public MarkException(Throwable arg0)
    {
        super("", arg0);
        msg = new MessageImpl();
        msg.setMessageKey(DEFAULT_EX_KEY);
